...
CHECK_ID="1.2.1.8"
DESCRIPTION="Ensure access to /etc/apt/sources.list.d directory is configured"
# -----------------------------------------------------
...
f_dir_access_chk()
{
    if [ -d "$l_dir" ]; then
        ...
        # Jika direktori tidak ada (jarang terjadi pada Debian), ini dianggap gagal audit 
        # karena APT memerlukan struktur direktori ini secara standar.
