...
f_sysctl_chk()
{
    ...
    # Cari semua file .conf yang diproses oleh systemd-sysctl (menggunakan tac untuk prioritas tertinggi)
...
if [ "${#a_output2[@]}" -le 0 ]; then
    ...
    RESULT="FAIL"
    NOTES+="FAIL: Sysctl symlink protection issues found | Reason(s): ${a_output2[*]}"
