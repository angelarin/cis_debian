...
CHECK_ID="v2 3.3.1.11"
DESCRIPTION="Ensure net.ipv4.conf.default.secure_redirects is configured"
# -----------------------------------------------------
...
if [ "${#a_output2[@]}" -le 0 ]; then
    ...
    RESULT="FAIL"
    NOTES+="FAIL: IPv4 secure ICMP redirect acceptance (default) is enabled or misconfigured | Reason(s): ${a_output2[*]}"
