...
CHECK_ID="v2 3.3.1.15"
DESCRIPTION="Ensure net.ipv4.conf.default.accept_source_route is configured"
# -----------------------------------------------------
...
if [ "${#a_output2[@]}" -le 0 ]; then
    ...
    RESULT="FAIL"
    NOTES+="FAIL: IPv4 default source route acceptance is enabled or misconfigured | Reason(s): ${a_output2[*]}"
