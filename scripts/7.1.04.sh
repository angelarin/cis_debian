...
if [ ! -f "$TARGET_FILE" ]; then
    # File backup group biasanya ada, jika tidak ada bisa dianggap FAIL atau INFO tergantung kebijakan
    ...
    # Trik $((0$VAR)) memastikan Bash membandingkan nilai Oktal dengan benar
