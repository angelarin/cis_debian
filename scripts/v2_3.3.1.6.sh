...
CHECK_ID="3.3.1.6"
DESCRIPTION="Ensure net.ipv4.icmp_ignore_bogus_error_responses is configured"
# -----------------------------------------------------
...
if [ "${#a_output2[@]}" -le 0 ]; then
    ...
    RESULT="FAIL"
    NOTES+="FAIL: Bogus ICMP error response ignoring is not properly configured | Reason(s): ${a_output2[*]}"
