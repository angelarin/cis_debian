...
f_sysctl_chk()
{
    ...
    # Cek file UFW jika ada (Sering ditemukan pada distribusi berbasis Debian)
...
if [ "${#a_output2[@]}" -le 0 ]; then
    ...
    RESULT="FAIL"
    NOTES+="FAIL: IPv4 ICMP redirect acceptance (all) is enabled or misconfigured | Reason(s): ${a_output2[*]}"
