...
# Jika IPv6 tidak aktif, dianggap PASS (Not Applicable)
if [[ "${a_output[*]}" == *"IPv6 is disabled"* ]]; then
    ...
    if [ "${#a_output2[@]}" -le 0 ]; then
        ...
        RESULT="FAIL"
        NOTES+="FAIL: IPv6 default Router Advertisement acceptance is enabled or misconfigured | Reason(s): ${a_output2[*]}"
